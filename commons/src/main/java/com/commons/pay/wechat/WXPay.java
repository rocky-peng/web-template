...
public class WXPay {
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        ...
        reqData.put("nonce_str", WXPayUtil.uuid());
    ...
    public String requestWithoutCert(String urlSuffix, Map<String, String> reqData) throws Exception {
        ...
        String resp = this.wxPayRequest.requestWithoutCert(urlSuffix, reqBody);
        return resp;
    }
    ...
    public String requestWithCert(String urlSuffix, Map<String, String> reqData) throws Exception {
        String reqBody = WXPayUtil.mapToXml(reqData);
        String resp = this.wxPayRequest.requestWithCert(urlSuffix, reqBody);
        return resp;
    }
    ...
    public Map<String, String> microPayWithPos(Map<String, String> reqData) throws Exception {
        ...
        int connectTimeoutMs = this.config.getConnectTimeoutMs();
        while (true) {
            ...
            try {
                ...
                WXPayConstants.log.info("microPayWithPos: try micropay again");
